...
{
    public class OcorrenciaRetornoController : Controller
    {
        public COAD.CORPORATIVO.Service.OcorrenciaRetornoSRV _service = new COAD.CORPORATIVO.Service.OcorrenciaRetornoSRV();
        ...
        [HttpPost]
        public ActionResult Listar(string bco = null, string cod = null, int pagina = 0)
        {
            Pagina<OcorrenciaRetornoDTO> page = _service.LerOcorrenciaRetorno(bco, cod, null, null, null, pagina, 7);
        ...
        [Autorizar(IsAjax = true)]
        [HttpPost]
        public ActionResult Salvar(OcorrenciaRetornoDTO ocorrencia)
        {
            ...
            try
            {
                if (ModelState.IsValid)
                {
                    ...
                    {
                        _service.SalvarOcorrenciaRetorno(ocorrencia);
                        scope.Complete();
                    }
                    return Json(result);
                }
