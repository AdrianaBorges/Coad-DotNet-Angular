...
namespace CONFIGSIS.Controllers
{
    public class LoginController : Controller
    {
        ...
        public LoginController(UsuarioSRV usuarioSRV)
        {
            this.usuarioSRV = usuarioSRV;
        }

        public UsuarioSRV usuarioSRV { get; set; }
        ...
        public ActionResult Login(string _login, string _senha)
        {
            ...
            try
            {
                string _retorno = usuarioSRV.RealizarLogin(_login, _senha, "CONFIGSIS", System.Web.HttpContext.Current);
