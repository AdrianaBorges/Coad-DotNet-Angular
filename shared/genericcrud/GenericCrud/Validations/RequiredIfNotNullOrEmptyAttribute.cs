...
namespace Coad.GenericCrud.Validations
{
    ...
    public class RequiredIfNotNullOrEmptyAttribute : RequiredAttribute, IValidationExpression
    {
        private String PropertyName { get; set; }
        private String OriginalMessage { get; set; }
        //private Object DesiredValue { get; set; }           

        public RequiredIfNotNullOrEmptyAttribute(String propertyName)
        {
        ...
        /// <summary>
        /// Verifica se a propriedade de teste é não nula para indicar para o filtro se ele deve ou não validar
        /// </summary>
        ...
        public bool NeedToValidate(object value, ValidationContext context)
        {
            ...
            // se o valor da propriedade for diferente de null ou uma não for uma string string vazia.
