        ...
        link: function (scope, element, attr, controller) {
            ...
            if (attr.ngModel) {
                ...
                scope.$parent.$watch(attr.appDate, function (value, old) {
                    ...
                    if ((controller._needConvert(value)) || (value != old) || ((value) && (!old)) )  {
        ...
        link: function (scope, element, attr, controller) {
            ...
            if (attr.ngModel) {
                ...
                scope.$parent.$watch(attr.appTime, function (value, old) {
                    ...
                    if ((controller._needConvert(value)) ||(value != old)) {
    ...
    return {
        ...
        controller: function ($scope, scopeBindService, cepService) {
            ...
            return {
                ...
                bind: function (sourceName, destinyName, sourceChange, destinyChange) {
        ...
        link: function (scope, element, attr, controller) {
            ...
            if (attr.sourceModel && attr.targetModel) {
                ...
                controller.bind(attr.sourceModel, attr.targetModel, attr.sourceChange, attr.destinyChange)
            }
        }    
    }
});
