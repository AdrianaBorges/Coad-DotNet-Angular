using ClientWebServiceNfe.DownloadNf;
using ClientWebServiceNfe.Model;
...
{
    class ClientWsDownloadNfe
    {
        private NfeDownloadNFSoapClient downloadClient { get; set; }
        public X509Certificate2 Certificado { get; set; }

        public ClientWsDownloadNfe()
        {
            Init();
        }

        public ClientWsDownloadNfe(X509Certificate2 cert)
        {
            Certificado = cert;
            Init();
        }
