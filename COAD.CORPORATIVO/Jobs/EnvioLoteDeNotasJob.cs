...
namespace COAD.CORPORATIVO.Jobs
{
    ...
    public class EnvioLoteDeNotasJob : JobBase
    {
        public override void Executar(IJobExecutionContext context, BatchContext batchContext)
        {
            ...
            if (inegrNFeSRV != null)
            {
                ...
                inegrNFeSRV.ExecutarTarefaEnviarLoteVigente(batchContext);
                inegrNFeSRV.ExecutarTarefaEnviarLoteVigenteNfSe(batchContext);
            }
        }
    }
}
