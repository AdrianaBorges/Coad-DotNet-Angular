...
{
    public class CnabArquivosItemDAO : AbstractGenericDao<CNAB_ARQUIVOS_ITEM, CnabArquivosItemDTO, int>
    {
        public COADCORPEntities db { get { return GetDb<COADCORPEntities>(); } set { } }

        public CnabArquivosItemDAO()
        {
        ...
        public IList<CnabArquivosItemDTO> Listar(DateTime? _data_ini, DateTime? _data_fim, string _ban_id, string _nome)
        {
            ...
            var query = (from i in db.CNAB_ARQUIVOS_ITEM
                         ...
                         select i).OrderByDescending(x => x.CNI_ID);
