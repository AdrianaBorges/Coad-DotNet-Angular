...
{
    [Mapping(typeof(PARCELA_PENDENTE))]
    public class ParcelaPendenteDTO : IPrototype<ParcelaPendenteDTO>
    {
        #region Atributos
        ...
        public ParcelaPendenteDTO Clone()
        {
            var novo = new ParcelaPendenteDTO()
            {
