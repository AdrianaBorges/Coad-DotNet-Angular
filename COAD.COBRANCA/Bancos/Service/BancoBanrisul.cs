...
namespace COAD.COBRANCA.Bancos.Service
{
    public class BancoBanrisul : IBanco
    {
        ...
        public string Logo => "banrisul-logo.jpg";
        public string BancoDesc => "041-8";
        ...
        public CamposLinhaDigitalDTO SepararCamposVariaveisLinhaDigitavel(CodigoBarrasDTO cb)
        {
            ...
            var resp = new CamposLinhaDigitalDTO()
            {
                Campo1 = campo1,
                Campo2 = campo2,
                Campo3 = campo3
        ...
        {
            var modulo = MathUtil.CalcularModuloCrescente(codigoBarras, 24, 11, 7);
